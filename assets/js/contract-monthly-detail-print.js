...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* 항목 행 생성 — 순번 옆에 일자 컬럼 추가 */
  const itemRows = items.map(item => `
    <tr>
      <td style="border:1px solid #999; padding:1.5mm 2mm; text-align:center;">${item.no}</td>
      <td style="border:1px solid #999; padding:1.5mm 2mm; text-align:center; white-space:nowrap;">${item.date || ''}</td>
  ...
  <div style="color:#000; font-size:9pt; font-family:'Pretendard Variable', sans-serif;">
    ...
    <!-- 제목 -->
    <h1 style="font-size:18pt; font-weight:bold; text-align:center; letter-spacing:0.4em; margin-bottom:6mm; border:2px solid #000; padding:3mm 0;">거래명세서(상세)</h1>
    ...
    <table style="width:100%; border-collapse:collapse; border:1px solid #000; border-top:none; font-size:8.5pt; margin-bottom:4mm;">
      <thead>
        <tr style="background:#f0f0f0;">
          ...
          <th style="border:1px solid #999; padding:1.5mm 2mm; text-align:center; width:16mm;">일자</th>
